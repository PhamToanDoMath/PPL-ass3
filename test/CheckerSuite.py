...
class CheckerSuite(unittest.TestCase):
    ...
    def test_9(self):
        ...
        """
        expect = "Type Mismatch In Statement: ConstDecl(Id(b),BoolType,FloatLit(1.72))"
    ...
    def test_21(self):
        ...
        """
        expect = "Type Mismatch In Statement: Call(Id(normal),Id(sub),[IntLit(1),BooleanLit(True)])"
    ...
    def test_24(self):
        ...
        Class Program{
            main(){
                Var a: Float;
                a = True + normal.sub(1,1);
            }
        }
        """
        expect = "Type Mismatch In Expression: BinaryOp(+,BooleanLit(True),CallExpr(Id(normal),Id(sub),[IntLit(1),IntLit(1)]))"
